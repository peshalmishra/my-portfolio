...
function Projects() {
    ...
    const handleNext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Projects.useCallback[handleNext]": ()=>{
            setCurrentIndex({
                "Projects.useCallback[handleNext]": (prev)=>(prev + 1) % projects.length
            }["Projects.useCallback[handleNext]"]);
        }
    }["Projects.useCallback[handleNext]"], []);
    const handlePrev = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Projects.useCallback[handlePrev]": ()=>{
            setCurrentIndex({
                "Projects.useCallback[handlePrev]": (prev)=>(prev - 1 + projects.length) % projects.length
            }["Projects.useCallback[handlePrev]"]);
        }
    }["Projects.useCallback[handlePrev]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Projects.useEffect": ()=>{
            ...
            return ({
                "Projects.useEffect": ()=>clearInterval(autoRotateTimer)
            })["Projects.useEffect"];
        }
    }["Projects.useEffect"], [
        isHovered,
    ...
    return(// FIX 4: Add ARIA landmark roles for accessibility
...
_s(Projects, "PPbjakN3ZhEo3YIj1DfqlyVMfrU=");
_c = Projects;
// ---------------------------------------------------------------------------
...
function GitHubActivity() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "GitHubActivity.useEffect": ()=>{
            ...
            const fetchContributions = {
                "GitHubActivity.useEffect.fetchContributions": async ()=>{
                    try {
                        ...
                        const totalCount = Object.values(json.total).reduce({
                            "GitHubActivity.useEffect.fetchContributions.totalCount": (a, b)=>a + b
                        }["GitHubActivity.useEffect.fetchContributions.totalCount"], 0);
                        // Group into weeks (Sunday-first)
                        const grouped = [];
                        let week = [];
                        contributions.forEach({
                            "GitHubActivity.useEffect.fetchContributions": (day, i)=>{
                                week.push({
                                    count: day.count,
                                    date: day.date
                                });
                        ...
                        }["GitHubActivity.useEffect.fetchContributions"]);
                        setWeeks(grouped);
                        setTotal(totalCount);
                    } catch  {
                        setError(true);
    ...
    const monthLabels = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "GitHubActivity.useMemo[monthLabels]": ()=>{
            ...
            let lastMonth = -1;
            weeks.forEach({
                "GitHubActivity.useMemo[monthLabels]": (week, wi)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full max-w-5xl mx-auto rounded-2xl border border-neutral-200 dark:border-white/8 bg-white/60 dark:bg-[#0a0a0a] backdrop-blur-sm p-6 md:p-8",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(GitHubActivity, "h/Ar0jRmtPFF6svz3kwZ4P6lm0U=");
_c1 = GitHubActivity;
// ---------------------------------------------------------------------------
            ...
            const interval = setInterval({
                "RotatingQuote.useEffect.interval": ()=>{
                    ...
                    setTimeout({
                        "RotatingQuote.useEffect.interval": ()=>{
                            setIdx({
                                "RotatingQuote.useEffect.interval": (prev)=>(prev + 1) % QUOTES.length
                            }["RotatingQuote.useEffect.interval"]);
                            setVisible(true);
                        }
...
_s2(RotatingQuote, "0+iMPXGgqmsOcEp533C5HL2fTsc=");
_c2 = RotatingQuote;
function LatestPush() {
    _s3();
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "LatestPush.useEffect": ()=>{
            const fetchLatest = {
                "LatestPush.useEffect.fetchLatest": async ()=>{
                    try {
                        ...
                        const pushEvent = events.find({
                            "LatestPush.useEffect.fetchLatest.pushEvent": (e)=>e.type === "PushEvent"
                        }["LatestPush.useEffect.fetchLatest.pushEvent"]);
            ...
            }["LatestPush.useEffect.fetchLatest"];
            fetchLatest();
        }
    }["LatestPush.useEffect"], []);
    const timeAgo = (date)=>{
...
_s3(LatestPush, "tsg+pvS0v/TG8y8Heyl/ASJ9eEE=");
_c3 = LatestPush;
...
_c4 = BehindTheCurtains;
var _c, _c1, _c2, _c3, _c4;
__turbopack_context__.k.register(_c, "Projects");
__turbopack_context__.k.register(_c1, "GitHubActivity");
__turbopack_context__.k.register(_c2, "RotatingQuote");
__turbopack_context__.k.register(_c3, "LatestPush");
__turbopack_context__.k.register(_c4, "BehindTheCurtains");
